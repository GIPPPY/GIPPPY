...
map_eng.set('nivel8', "''' NIVEL 8\nWhile instruction...Introducimos ahora el el concepto de bucle repetitivo, el cual ejecuta las instrucciones que contiene mientras la condición se cumpla.\nPara evitar que entre en un bucle infinito el robot parará después de repetir 25 instrucciones.\n.\n'''\n\nmientras(no_choca):\n  avanza(2)\n  gira(1)");
...
map_vlc.set('nivel8', "''' NIVELL 8\nIntroducï ara el concepte de bucle repetitiu, el qual executa las instrucciones que contiene mientras la condición se cumpla.\nPara evitar que entre en un bucle infinito el robot parará después de repetir 25 instrucciones.\n.\n'''\n\nmientras(no_choca):\n  avanza(2)\n  gira(1)");
